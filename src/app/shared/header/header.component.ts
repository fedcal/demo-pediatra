  ...
  template: `
    <header class="site-header">
      <div class="site-header__inner">
        <a routerLink="/" class="brand" aria-label="Home Dr. Marini Pediatria">
          <span class="brand__icon" aria-hidden="true">👶</span>
          <span class="brand__text">Dr. Marini Pediatria</span>
        </a>
        <nav class="site-nav" aria-label="Navigazione principale">
          ...
          <a routerLink="/vaccinazioni" routerLinkActive="is-active">Vaccinazioni</a>
