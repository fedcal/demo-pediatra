...
const SLUG = 'pediatra';
const TITLE = 'Demo Pediatra Privato — Federico Calò';

export default defineConfig({
  title: TITLE,
  description: 'Documentazione tecnica del template Angular 21 SSR per Pediatra Privato.',
  base: `/demo-${SLUG}/`,
  cleanUrls: true,
  lang: 'it-IT',

  themeConfig: {
    siteTitle: 'Demo Pediatra Privato',
