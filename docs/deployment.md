...
URL: `https://pediatra.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `pediatra.demo.federicocalo.dev`
...
- Output directory: `dist/pediatra/browser`
...
URL: `https://fedcal.github.io/federico-demo-pediatra/`
...
- `base: /federico-demo-pediatra/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `pediatra-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   pediatra-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `pediatra-docs.federicocalo.dev`
